...
/// (see `_getCostColor`): colors[0]=Supply, colors[1]=Controlled,
/// colors[2]=Off-peak, colors[3]=Shoulder, colors[4]=Peak.
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(entry.label, style: const TextStyle(color: MomentumPalette.mutedBright, fontSize: 11)),
      ],
    );
  }
}
